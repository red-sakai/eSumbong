...
const List<(List<String>, String)> _ezuRules = <(List<String>, String)>[
  ...
  (
    ...
    '📋 **RA 9262 — Anti-Violence Against Women and Their Children Act of 2004**\n\n'
        '**Purpose:** Protects women and their children from physical, sexual, psychological, and economic abuse by their intimate partners or family members.\n\n'
        '**Key Provisions:**\n'
        ...
        '**Penalties:** Imprisonment ranging from 1 month to 20 years, depending on the gravity of the offense, plus fines.\n\n'
  ...
  (
    ...
    '📋 **RA 7160 — Local Government Code of 1991**\n\n'
        '**Purpose:** Decentralizes government functions and empowers local government units (LGUs), including barangays.\n\n'
        ...
        '**Penalties:** Non-compliance with the mandatory conciliation requirement results in dismissal of the case in court.\n\n'
        '⚠️ This is general legal information only and does not constitute legal advice. Consult a licensed Philippine attorney for case-specific guidance.',
  ),
  ...
  (
    ...
    '📋 **RA 7610 — Special Protection of Children Against Abuse, Exploitation and Discrimination Act**\n\n'
        '**Purpose:** Provides stronger deterrence against child abuse, exploitation, and discrimination, and grants special protection to children in difficult circumstances.\n\n'
        '**Key Provisions:**\n'
        ...
        '**Penalties:** Imprisonment of 6 years and 1 day to 40 years, depending on the offense, plus perpetual or temporary disqualification from public office.\n\n'
        '⚠️ This is general legal information only and does not constitute legal advice. Consult a licensed Philippine attorney for case-specific guidance.',
  ),
  ...
  (
    ...
    '📋 **RA 9344 — Juvenile Justice and Welfare Act of 2006**\n\n'
        '**Purpose:** Establishes a comprehensive juvenile justice and welfare system to address the needs of children in conflict with the law (CICL).\n\n'
        '**Key Provisions:**\n'
        ...
        '**Penalties:** No imprisonment for CICL; intervention and rehabilitation programs are prioritized.\n\n'
        '⚠️ This is general legal information only and does not constitute legal advice. Consult a licensed Philippine attorney for case-specific guidance.',
  ),
  ...
  (
    ...
    '📋 **RA 10173 — Data Privacy Act of 2012**\n\n'
        '**Purpose:** Protects individual personal information in information and communications systems in government and the private sector.\n\n'
        '**Key Provisions:**\n'
        ...
        '**Penalties:** Imprisonment of 1–6 years and fines ranging from ₱500,000 to ₱4,000,000 depending on the violation.\n\n'
        '⚠️ This is general legal information only and does not constitute legal advice. Consult a licensed Philippine attorney for case-specific guidance.',
  ),
  ...
  (
    ...
    '⚖️ **Katarungang Pambarangay (KP) Process**\n\n'
        'The KP system under RA 7160 requires most disputes between residents of the same barangay to be brought to the barangay first before going to court.\n\n'
        '**Steps:**\n'
        ...
        '6. **Settlement or Certificate to File Action** — If settled, an amicable settlement is signed. If not, a Certificate to File Action (CFA) is issued allowing court filing.\n\n'
        '⚠️ This is general legal information only and does not constitute legal advice. Consult a licensed Philippine attorney for case-specific guidance.',
  ),
  ...
  (
    ...
    '📝 **How to File a Complaint at the Barangay**\n\n'
        ...
        '5. If no settlement is reached, you will receive a **Certificate to File Action (CFA)** to bring your case to court\n\n'
        '**Note:** Barangay conciliation is mandatory for disputes between residents of the same city/municipality before filing in court.\n\n'
        '⚠️ This is general legal information only and does not constitute legal advice. Consult a licensed Philippine attorney for case-specific guidance.',
  ),
  ...
  (
    ...
    '⚖️ **Estafa (Swindling) under the Revised Penal Code (Art. 315)**\n\n'
        '**What is Estafa?** It is a crime committed by deceiving another person to defraud them of money, property, or services.\n\n'
        '**Common forms:**\n'
        ...
        'You may file a complaint at the barangay first if the respondent is a co-resident, otherwise directly with the Prosecutor\'s Office.\n\n'
        '⚠️ This is general legal information only and does not constitute legal advice. Consult a licensed Philippine attorney for case-specific guidance.',
  ),
...
class EzuGeminiService {
  ...
  Future<String> send(String userMessage) async {
    ...
    for (final (keywords, response) in _ezuRules) {
