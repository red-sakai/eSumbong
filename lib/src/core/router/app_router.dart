...
final appRouterProvider = Provider<GoRouter>((ref) {
  return GoRouter(
    ...
    routes: <RouteBase>[
      ...
      GoRoute(path: '/notifications', builder: (_, state) => const NotificationsScreen(showAppBar: true)),
      GoRoute(path: '/profile', builder: (_, state) => const ProfileScreen(showAppBar: true)),
      GoRoute(path: '/qr-verify', builder: (_, state) => const QrVerificationScreen()),
    ],
  );
});
